...
const Hero = () => {
  return (
    <section className="w-full h-fit pt-0 relative overflow-visible">
      <div
        className={`flex justify-center md:justify-start flex-col items-center border-b-2 h-[700px] border-gray-900 bg-no-repeat bg-cover bg-center bg-[url("https://images.pexels.com/photos/1303097/pexels-photo-1303097.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")]`}
      >
