...
const Cart = () => {
  ...
  return (
    <>
      <div className="h-screen bg-gray-100 dark:bg-gray-700 pt-20">
        <h1 className="mb-10 text-center text-2xl font-bold">Your Items</h1>
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
          <div className="rounded-lg md:w-2/3">
            <div className="justify-between mb-6 rounded-lg bg-white dark:bg-gray-600 p-6 shadow-md sm:flex sm:justify-start">
              <img
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  <div className="flex items-center border-gray-100">
                    <span className="cursor-pointer rounded-l bg-gray-100 dark:bg-gray-700 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50">
                      {" "}
                      -{" "}
                    </span>
                    <input
                      ...
                      min="1"
                    />
                    <span className="cursor-pointer rounded-r bg-gray-100 dark:bg-gray-700 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50">
                      {" "}
                      +{" "}
                    </span>
                  </div>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white dark:bg-gray-700 p-6 shadow-md md:mt-0 md:w-1/3">
            <div className="mb-2 flex justify-between">
              ...
              <p className="text-gray-700 dark:text-gray-100">$129.99</p>
            </div>
            <div className="flex justify-between">
              <p className="text-gray-700 dark:text-gray-100">Shipping</p>
              <p className="text-gray-700 dark:text-gray-100">$4.99</p>
            </div>
            <hr className="my-4" />
            <div className="flex justify-between">
